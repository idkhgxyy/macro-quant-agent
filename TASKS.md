...
- [ ] CI：ruff bug-lint + pytest（已落地），scoped mypy 第一批模块（已落地），全仓 type-check（待补）
...
- 2026-05-10：落地第一批 scoped mypy：新增 [mypy.ini](file:///Users/gxyy/Documents/isolation/mypy.ini) 只检查 [run_scheduler.py](file:///Users/gxyy/Documents/isolation/run_scheduler.py)、[server.py](file:///Users/gxyy/Documents/isolation/dashboard/server.py)、[heartbeat.py](file:///Users/gxyy/Documents/isolation/utils/heartbeat.py)、[run_lock.py](file:///Users/gxyy/Documents/isolation/utils/run_lock.py)，采用 `follow_imports=skip` 与 `ignore_missing_imports=True` 先聚焦运行守卫链路；同时修复这些文件中的路径可空、环境变量整型转换、弱类型 `dict.get()` 等问题；更新 [ci.yml](file:///Users/gxyy/Documents/isolation/.github/workflows/ci.yml) 在 GitHub Actions 中新增 `python -m mypy --config-file mypy.ini`。
